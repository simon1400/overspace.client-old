...
!(function(t, e) {
  ...
  function se(t, e) {
    return (
      (t = be(t)), O(e) ? t.innerHTML : ae(t.hasChildNodes() ? oe(t) : t, e)
    );
  }
  function ae(e, t) {
    return (
    ...
    ["left", "top"].forEach(function(t) {
      if (t in n) {
        ...
        De(
          i,
          t,
          n[t] - r[t] + P("absolute" === o && "auto" === e ? Qe(i)[t] : e)
        );
      }
    });
  }
  function Ze(t) {
    ...
    kt(t) ||
      ((e = Q(t, "style")),
      (i = Q(t, "hidden")),
      Q(t, { style: (e || "") + ";display:block !important;", hidden: null }));
  ...
  function Qe(n) {
    var r = (n = H(n)).offsetParent || fi(n).documentElement,
      ...
      t = ["top", "left"].reduce(function(t, e) {
        ...
        return (
          (t[e] -=
            o[e] + P(De(n, "margin" + i)) + P(De(r, "border" + i + "Width"))),
          t
        );
      }, Je(n));
  ...
  function ii(n) {
    ...
    return function(t, e) {
      if (((t = H(t)), O(e))) {
        ...
        return (
          (e = "auto" === (e = De(t, n)) ? t["offset" + r] : P(e) || 0) -
          ni(n, t)
        );
      }
    ...
    return (
      ...
      De(i, "boxSizing") === e
        ? Ke[t]
            ...
            .reduce(function(t, e) {
              return (
                t + P(De(i, "padding" + e)) + P(De(i, "border" + e + "Width"))
              );
            }, 0)
        : 0
    );
          ...
          return new Xt(function(t) {
            ...
            if (d.queued && O(u) && O(c) && d.hasAnimation && !(l.length < 2)) {
              var o = document.body,
                ...
                a = n[0],
                h =
                  (Xe.inProgress(a) && Te(a, "uk-animation-leave")) ||
                  (Ve.inProgress(a) && "0px" === a.style.height);
              (e = i(n)),
                h ||
                  (e = e.then(function() {
                    var t = i(r);
                  ...
                  ? ((c = (l = this).isToggled),
                    ...
                    function(t, e) {
                      var i = Ve.inProgress(t),
                        n = t.hasChildNodes
                          ? P(De(t.firstElementChild, "marginTop")) +
                      ...
                      return (
                        ...
                        (e
                          ? Ve.start(
                              t,
                              R({}, d, { overflow: "hidden", height: o }),
                              Math.round(u * (1 - r / o)),
                              p
                            )
                          : Ve.start(t, f, Math.round(u * (r / o)), p).then(
                              function() {
                                return m(t, !1);
                              }
                            )
        ...
        _toggle: function(t, e) {
          ...
          t &&
            ...
            this.cls
              ...
              : (i = e === tt(t, "hidden")) && Q(t, "hidden", e ? null : ""),
  ...
  var Wi = {
      ...
      events: [
        {
          ...
          handler: function(t) {
            t.preventDefault(),
              this.toggle(
                ne(
                  ye(this.targets + " " + this.$props.toggle, this.$el),
                  t.current
                )
              );
          }
      ...
      update: function() {
        ...
        var t =
          !this.collapsible && !Te(this.items, this.clsOpen) && this.items[0];
        t && this.toggle(t, !1);
      },
      methods: {
        toggle: function(r, o) {
                ...
                if (i || !e || s.collapsible || !(a.length < 2)) {
                  ...
                  t._wrapper ||
                    ...
                    s.toggleElement(t._wrapper, i, o).then(function() {
                      Te(t, s.clsOpen) === i &&
                        (i || s._toggle(n, !1), (t._wrapper = null), pe(n));
                    });
                }
              });
        }
          ...
          handler: function(t) {
            ...
            this.$el === e
              ? ((Ri = this.isActive() ? null : Ri),
                ...
                this.tracker.cancel())
              : (Ri =
                  null === Ri && Tt(e, this.$el) && this.isToggled()
                    ? this
                    : Ri);
          }
        },
      ...
      },
      {
        read: function(t) {
          ...
          return {
            scrolled:
              !!this.parallax &&
              li(this.$el, e ? e - ti(this.$el) : 0) * this.parallax
          };
        },
        write: function(t) {
          var e = t.rows,
            ...
            },
            {
              write: function() {
                ...
                this.elements.forEach(function(t) {
                  ...
                  e &&
                    (i.forceHeight ||
                      Math.round(e + ni("height", t, "content-box")) >=
                        t.offsetHeight) &&
                    De(t, "height", e);
                });
              },
  ...
  function an(t) {
    ...
    return (
      o &&
        s &&
        (De(t, "minHeight", ""), (e = hn(t)), (n = e.heights), (r = e.max)),
      {
        heights: (n = t.map(function(t, e) {
          return n[e] === r && P(t.style.minHeight).toFixed(2) !== r.toFixed(2)
            ? ""
            : r;
        })),
        elements: t
  ...
  var ln = {
    ...
    update: {
      read: function() {
        ...
        if (this.expand)
          t =
            ti(window) - (cn(document.documentElement) - cn(this.$el)) - e ||
            "";
        else {
          ...
          !0 === this.offsetBottom
            ...
            : D(this.offsetBottom)
              ...
              : this.offsetBottom && u(this.offsetBottom, "px")
                ...
                : _(this.offsetBottom) &&
                  (t += " - " + cn(nt(this.offsetBottom, this.$el)) + "px"),
            (t += (e ? " - " + e + "px" : "") + ")");
        }
        return { minHeight: t };
      },
  ...
  var mn = {},
    ...
    yn = {
      ...
      computed: {
        icon: function(t, e) {
          var i = t.icon;
          return Te(e, "uk-search-icon") && vt(e, ".uk-search-large").length
            ? "search-large"
    ...
    kn = {
      ...
      connected: function() {
        ...
        this.svg.then(function(t) {
          return (
            1 !== e.ratio && De(be("circle", t), "strokeWidth", 1 / e.ratio)
          );
        }, K);
      }
    };
        ...
        : this.isImg &&
          ...
          In(
            ...
            (function(t, e, i) {
              var n;
              i &&
                ((n = Z.ratio({ width: t, height: e }, "width", An(Tn(i)))),
                (t = n.width),
                (e = n.height));
              return (
      ...
      load: function(t) {
        ...
        t.some(function(t) {
          ...
          ((this._data.image = ee(
            ...
            return (
              In(e.$el, On(t), t.srcset, t.sizes), (Bn[e.cacheKey] = On(t)), t
            );
          }, K)),
          this.observer.disconnect());
      },
  ...
  function In(t, e, i, n) {
    if (Dn(t)) n && (t.sizes = n), i && (t.srcset = i), e && (t.src = e);
      ...
      !b(t.style.backgroundImage, e) &&
        (De(t, "backgroundImage", "url(" + bt(e) + ")"), jt(t, Wt("load", !1)));
    }
  }
              ...
              i
                ? this.stack
                  ...
                  : ((Hn = i).isToggled()
                      ...
                      : Lt(i.$el, "beforeshow hidden", this.show, !1, function(
                          t
                        ) {
                          var e = t.target;
        ...
        read: function() {
          return (
            !(!this.content || !this.container) && {
              ...
              max: Math.max(
                150,
                ti(this.container) - (Je(this.content).height - ti(this.$el))
              )
            }
          );
        },
    ...
    Gn = {
      ...
      update: {
        ...
        write: function(t) {
          ti(
            this.$el,
            Z.contain({ height: this.height, width: this.width }, t).height
          );
        },
        events: ["resize"]
      }
    ...
    Jn = {
      ...
      methods: {
        scrollTo: function(i) {
          ...
          if (
            (t < r + e && (r = t - e), jt(this.$el, "beforescroll", [this, i]))
          ) {
            var o = Date.now(),
      ...
      update: [
        {
          write: function() {
            this.hidden &&
              De(
                St(this.elements, ":not(." + this.inViewClass + ")"),
                "visibility",
                "hidden"
              );
          }
          ...
          write: function(t) {
            ...
            this.links.forEach(function(t) {
              ...
              e &&
                jt(this.$el, "active", [
                  e,
                  ke(this.closest ? gt(e, this.closest) : e, this.cls)
                ]);
          },
          events: ["scroll", "resize"]
        }
    ...
    tr = {
      ...
      computed: {
        ...
        isActive: {
          ...
          set: function(t) {
            t && !this.isActive
              ? (Se(this.selTarget, this.clsInactive, this.clsActive),
                jt(this.$el, "active"))
              : t ||
                Te(this.selTarget, this.clsInactive) ||
                (Se(this.selTarget, this.clsActive, this.clsInactive),
                jt(this.$el, "inactive"));
          }
        }
      },
                ...
                pi.read(function() {
                  ...
                  n.isFixed &&
                    ...
                    ci(
                      ...
                      t -
                        i -
                        (D(n.targetOffset) ? n.targetOffset : 0) -
                        n.offset
                    );
                });
            }
      ...
      update: [
        {
          read: function(t, e) {
            ...
            return (
              (this.top =
                Math.max(P(er("top", this)), this.topOffset) - this.offset),
              (this.bottom = n && n - i),
          ...
          write: function(t) {
            var e = t.height,
              ...
              n = this.placeholder;
            De(n, R({ height: e }, i)),
              Tt(n, document) || (le(this.$el, n), Q(n, "hidden", "")),
      ...
      methods: {
        ...
        show: function(t) {
          for (
            ...
            if (
              !pt(this.toggles[l], ".uk-disabled *, .uk-disabled, [disabled]")
            ) {
          ...
          return (
            ...
            Xt.all(
              r
                ...
                .concat(
                  Ve.start(this.target, { height: s }, this.animation, "ease")
                )
            ).then(function() {
              r.forEach(function(t, e) {
                return De(t, {
        ...
        if ((void 0 === e && (e = !1), !this.dragging && this.length)) {
          ...
          if ((n[e ? "unshift" : "push"](t), !e && 1 < n.length))
            ...
            if (a !== l) {
              ...
              return (
                a && jt(a, "itemhide", [this]), jt(l, "itemshow", [this]), d
              );
            }
            o();
          }
          ...
          return {
            ...
            show: function(t, e, i) {
              ...
              return (
                ...
                Xt.all([Ve.start(s, l[1], t, r), Ve.start(o, l[0], t, r)]).then(
                  function() {
                    n.reset(), c.resolve();
                  },
                  K
              ...
              if ("image" === i || e.match(/\.(jp(e)?g|png|gif|svg)($|\?)/i))
                ...
                Q(a, "src", e),
                  Lt(a, "error loadedmetadata", function(t) {
                    "error" === t
                      ? s.setError(r)
                      : (Q(a, { width: a.videoWidth, height: a.videoHeight }),
                        s.setItem(r, a));
                  });
                ...
                ee(
                  ...
                  var e = t.width,
                    i = t.height;
                  120 === e && 90 === i
                    ? ee("https://img.youtube.com/vi/" + h + "/0.jpg").then(
                        function(t) {
                          var e = t.width,
                            i = t.height;
                          return l(e, i);
      ...
      computed: {
        props: function(f, p) {
          ...
          return _r.reduce(function(t, e) {
            ...
            s && De(p, e, ""),
              a.length < 2 &&
                a.unshift(("scale" === e ? 1 : s ? De(p, e) : 0) || 0);
            var h = b(a.join(""), "%") ? "%" : "px";
            if (o) {
              var l = p.style.color;
              (a = a.map(function(t) {
      ...
      update: {
        ...
        write: function(t) {
          ...
          t.active
            ...
            : De(this.$el, { backgroundSize: "", backgroundRepeat: "" });
        },
        events: ["resize"]
      },
      methods: {
          ...
          return {
            ...
            translate: function(t) {
              ...
              De(
                a,
                "transform",
                wr(X(e - e * t - l, -Fr(a), jr(a).width) * (Ct ? -1 : 1), "px")
              ),
            ...
            percent: function() {
              return Math.abs(
                (De(a, "transform").split(",")[4] * (Ct ? -1 : 1) + i) / (l - i)
              );
            },
            getDistance: function() {
              return Math.abs(l - i);
          ...
          ye(
            ...
            i.maxIndex &&
              Ee(
                t,
                "uk-hidden",
                D(e) && ((i.sets && !b(i.sets, P(e))) || e > i.maxIndex)
              );
          });
        },
        events: ["resize"]
    ...
    Jr = {
      ...
      update: {
        write: function() {
          if (
            (this.clsEmpty &&
              Ee(this.$el, this.clsEmpty, !this.$el.children.length),
            De(
              this.handle ? ye(this.handle, this.$el) : this.$el.children,
              "touchAction",
              "none"
            ),
            this.drag)
      ...
      methods: {
        ...
        insert: function(i, n) {
          ...
          var t = function() {
            ...
            n
              ? !Tt(i, r.$el) ||
                ((e = n), (t = i).parentNode === e.parentNode && ne(t) > ne(e))
                ? he(n, i)
                : le(n, i)
              : ae(r.$el, i);
          };
...
$(function() {
  $(".hamburger").click(function() {
    $("nav").toggleClass("active_mnu_mobile");
